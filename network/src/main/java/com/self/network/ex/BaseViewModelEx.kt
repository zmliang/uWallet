...
import com.self.network.exception.AppException
import com.self.network.exception.ExceptionHandle
import com.self.network.paresException
import com.self.network.paresResult
import com.self.network.util.loge
...
fun <T> BaseViewModel.request(
    ...
    return viewModelScope.launch {
        runCatching {
            ...
            //网络请求成功 关闭弹窗
            dismissLoading.postValue(false)
            runCatching {
