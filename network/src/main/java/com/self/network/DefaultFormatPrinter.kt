...
import com.self.network.util.CharacterUtil.Companion.xmlFormat
import com.self.network.interceptor.LogInterceptor.Companion.isJson
import com.self.network.interceptor.LogInterceptor.Companion.isXml
import com.self.network.util.LogUtil
