...
import com.zml.zbar.scan.IViewFinder;
...
public class ViewFinderView extends RelativeLayout implements IViewFinder {
    ...
    private void initLayout() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_finder, this, true);
    }
    ...
    public synchronized void updateFramingRect() {
        ...
        height = width;//(int) (heightWidthRatio * width);
